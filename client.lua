...
idGunC = {}
Tunnel.bindInterface(GetCurrentResourceName(), idGunC)
Proxy.addInterface(GetCurrentResourceName(), idGunC)
idGunS = Tunnel.getInterface(GetCurrentResourceName(), GetCurrentResourceName())
...
Citizen.CreateThread(function()                             -- Create the thread.
    while true do                                           -- Loop it infinitely.
        ...
        if infoOn then                                      -- If the info is on then...
            pause = 4                                       -- Only loop every 5ms (equivalent of 200fps).
